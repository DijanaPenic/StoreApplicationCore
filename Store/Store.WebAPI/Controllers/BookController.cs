...
namespace Store.WebAPI.Controllers
{
    ...
    public class BookController : ApplicationControllerBase
    {
        ...
        [SectionAuthorization(SectionType.Book, SectionPolicy.Read)]
        ...
        [SectionAuthorization(SectionType.Book, SectionPolicy.Create)]
        ...
        [Route("{bookId:guid}")]
        [Consumes("application/json")]
        [SectionAuthorization(SectionType.Book, SectionPolicy.Update)]
        ...
        [HttpDelete]
        [Route("{bookId:guid}")]
        [SectionAuthorization(SectionType.Book, SectionPolicy.Delete)]
