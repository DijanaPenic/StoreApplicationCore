...
namespace Store.WebAPI.Infrastructure.Authorization.Attributes
{
    public class HangfireDashboardAuthorizationAttribute : IDashboardAuthorizationFilter
    {
        ...
        public HangfireDashboardAuthorizationAttribute(TokenValidationParameters tokenValidationParameters, ILogger<HangfireDashboardAuthorizationAttribute> logger)
        {
